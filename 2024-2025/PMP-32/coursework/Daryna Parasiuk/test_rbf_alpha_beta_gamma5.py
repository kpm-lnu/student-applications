...
df_train = pd.read_csv("lotka_volterra_results5_alpha_beta_gamma.csv")  # <-- Файл для 3 змінних
...
# rbf_model = RBFInterpolator(X_train, y_train, kernel='gaussian', epsilon=0.1)
rbf_model = RBFInterpolator(X_train, y_train, kernel='cubic')

# === 3. Завантаження тестової вибірки ===
df_test = pd.read_csv("test_alpha_beta_gamma_lhs_5.csv")  # <-- тестовий файл для 3 змінних
