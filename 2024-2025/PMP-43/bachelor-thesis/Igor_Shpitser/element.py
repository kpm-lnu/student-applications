...
class AxisymmetricElement:
    ...
    def compute_element_stiffness(self, mesh: "Mesh", Ke30=None, Ke2=None):
        ...
        if Ke30 is not None and Ke2 is not None:
            numerator = norm(Ke - Ke30)
            denominator = norm(Ke2 - Ke30)
            fitness = numerator / denominator if denominator != 0 else np.inf
            return Ke, fitness
