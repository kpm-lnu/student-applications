...
export function AppointmentsPage() {
  ...
  return (
    <div className={styles.root}>
      <span className={styles.pageTitle}>Всі записи</span>
                      ...
                      <td className={styles.td}>
                        <div className={styles.actions}>
                          ...
                          {(a.status === AppointmentStatus.Confirmed ||
                            a.status === AppointmentStatus.Pending) && (
                            <button className={styles.cancelBtn} onClick={() => updateStatus(a.id, AppointmentStatus.Cancelled)}>
                              Скасувати
                            </button>
                          )}
                          {a.status === AppointmentStatus.Confirmed && (
                            <button className={styles.completeBtn} onClick={() => updateStatus(a.id, AppointmentStatus.Completed)}>
                              Завершити
                            </button>
                          )}
                        </div>
