        ...
        if CIoU or DIoU or WIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            if CIoU:  # https://github.com/Zzh-tju/DIoU-SSD-pytorch/blob/master/utils/box/box_utils.py#L47
                ...
                return iou - (rho2 / c2 + v * alpha)  # CIoU
                    ...
                    exp_w = torch.exp(rho2 / c2)
                    wiou_loss1 = exp_w * (1.0 - iou)
                    
                    # (Batch-wise beta)
                    iou_loss = 1.0 - iou
                    mean_iou_loss = iou_loss.detach().mean()
                    beta = iou_loss.detach() / (mean_iou_loss + eps)
                    
                    alpha_w = 1.9
                    delta_w = 3.0
                    r = beta / (delta_w * torch.pow(alpha_w, beta) - delta_w + eps)
                    
                    wiou_loss3 = r * wiou_loss1
                    
                    return 1.0 - wiou_loss3
