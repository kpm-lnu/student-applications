...
from config import (DATASET_ROOT, CONF_THRESH, NMS_IOU_THRESH,
                    DEVICE, RESULTS_DIR)
from detector       import Detector
from tracker        import ByteTrackIMM
from dataset_utils  import load_tracking_split, TrackingSequence
...
def evaluate_tracking(weights: str) -> dict:
    ...
    sequences = load_tracking_split(DATASET_ROOT / "tracking" / "test")
    if not sequences:
